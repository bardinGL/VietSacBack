...
namespace VietSacBackend.Migrations
{
    ...
    [Migration("20240710233800_SeedProducts")]
            ...
            modelBuilder.Entity("VietSacBackend._3.Repository.Data.ProductEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "17",
                            CreatedTime = new DateTimeOffset(new DateTime(2024, 7, 10, 23, 37, 59, 675, DateTimeKind.Unspecified).AddTicks(6015), new TimeSpan(0, 0, 0, 0, 0)),
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2024, 7, 10, 23, 37, 59, 675, DateTimeKind.Unspecified).AddTicks(6015), new TimeSpan(0, 0, 0, 0, 0)),
                            category_id = "1"
                        },
                        new
                        {
